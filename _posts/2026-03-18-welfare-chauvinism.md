---
layout: post
title: "Welfare Chauvinism and Party Strategy in Denmark (2011–2022)"
date: 2026-03-18
category: "Thesis Analysis"
excerpt: "Investigates welfare chauvinism — the combination of support for generous welfare for natives and opposition to immigrant welfare rights — among Danish voters across four election waves. Finds that Socialdemokratiet's dual strategy raised the welfare chauvinist share of its electorate from 33% to 46% by 2019, with the strongest evidence concentrated in the election year S ran most explicitly on the strategy."
---

*Evidence from the Danish National Election Study (2011–2022)*
...
This study investigates welfare chauvinism among Danish voters using four waves of the Danish National Election Study (DNES: 2011, 2015, 2019, 2022; N=11,470 total respondents). Welfare chauvinism — the combination of support for generous welfare provision for natives and opposition to extending welfare to immigrants — has become a central concept in understanding the politics of the welfare state in multiethnic societies (van Oorschot 2006; Careja & Harris 2022). The Danish case is particularly instructive because Socialdemokratiet (S) has pursued an explicit dual strategy since approximately 2015: restrictive on immigration and cultural integration, while maintaining or expanding welfare generosity for Danish workers. This creates a natural test of whether welfare chauvinism forms a coherent and electorally consequential attitude cluster, and whether S has successfully captured the welfare chauvinist voter segment.
...
# 2. S's Dual Strategy — CHES Evidence

The Chapel Hill Expert Survey (CHES) provides systematic expert-rated measures of party positions across multiple dimensions. These data document the elite-level precondition for welfare chauvinism to become electorally relevant: S's simultaneous rightward move on immigration and maintenance of its leftist economic position.
...
# 3. Descriptive Patterns — The Welfare Chauvinist Voter
...
Table 1 reports the percentage of each party's voters classified as welfare chauvinists (above-median on both dimensions) in each wave.

| Party | 2011 | 2015 | 2019 | 2022 |
|---|---|---|---|---|
| A (S) | 33.3 | 33.5 | **46.2** | 32.0 |
| V | 9.8 | 12.8 | 17.5 | 5.4 |
| O (DF) | 34.8 | 34.5 | **46.2** | 23.3 |
| F (SF) | 24.3 | 22.2 | 22.2 | 22.2 |
| B (RV) | 12.3 | 7.1 | 16.2 | 7.4 |
| Ø (EL) | 13.1 | 24.3 | 27.3 | 9.7 |
| **All voters** | **21.0** | **25.8** | **31.4** | **20.5** |

*Table 1: Percentage of each party's voters in the welfare chauvinist quadrant (above-median on both welfare generosity and immigration restrictiveness).*
...
# 4. Regression Results — Attitude Coherence Over Time

## Model 1: Per-Wave Correlations

The first set of models regresses immigration restrictiveness (welfare rights item) on welfare generosity, separately for each wave, among S and V voters. The welfare generosity coefficient is negative and significant in every wave: 2011 (β=−0.222, SE=0.032, p<0.001, n=935), 2015 (β=−0.183, SE=0.034, p<0.001, n=805), 2019 (β=−0.238, SE=0.033, p<0.001, n=975), and 2022 (β=−0.194, SE=0.032, p<0.001, n=951). The negative sign indicates that voters with higher welfare generosity tend to have lower immigration restrictiveness — the opposite of the welfare chauvinist prediction.

This result deserves careful interpretation. The negative correlation does not mean welfare chauvinism does not exist — it clearly does, as the quadrant analysis demonstrates. Rather, it means that across the full S+V voter population, the dominant pattern is one of ideological consistency (left on both dimensions or right on both) rather than cross-cutting welfare chauvinism. The welfare chauvinist voters are a substantial minority, but they are outnumbered by ideologically consistent voters. The correlation is broadly stable across waves (ranging from −0.18 to −0.24), showing no clear trend toward either strengthening or weakening attitude coherence.
...
|---|---|---|---|---|---|
| M1: Per-wave 2011 | −0.222 | 0.032 | <0.001 | 935 | 0.048 |
| M1: Per-wave 2015 | −0.183 | 0.034 | <0.001 | 805 | 0.035 |
| M1: Per-wave 2019 | −0.238 | 0.033 | <0.001 | 975 | 0.051 |
| M1: Per-wave 2022 | −0.194 | 0.032 | <0.001 | 951 | 0.037 |
| M1b: party_A × post | **0.189** | 0.078 | **0.016** | 3,661 | 0.063 |
| M2: wg × pA × w2019 | 0.002 | 0.097 | 0.981 | 3,666 | 0.074 |
| M2: wg × pA × w2022 | 0.171 | 0.103 | 0.097 | | |
| M3: party_A × post | **0.205** | 0.079 | **0.010** | 6,054 | 0.190 |
| M3: party_Ø × post | −0.211 | 0.126 | 0.094 | | |

*Table 2: Summary Regression Results. DV = immigration restrictiveness (welfare rights item, 1–5). M1 per-wave: coefficient on welfare generosity. M1b/M2/M3: interaction coefficients from pooled models. S+V sample for M1/M1b/M2; all six parties for M3 (V as reference).*
...
## Alternative Welfare Generosity Measures

All four components of the welfare generosity index show significant negative associations with immigration restrictiveness in all waves: social reforms (β ranging from −0.165 to −0.411), income leveling (−0.397 to −0.460), tax-versus-service (−0.320 to −0.464), and tax-high-incomes (−0.327 to −0.764). The tax-high-incomes item shows the strongest relationship in 2019 (β=−0.764), suggesting that preferences for progressive taxation are particularly predictive of immigration attitudes in the election year where S's dual strategy was most salient.
...
Among S voters, the correlation between folkepension and refugee spending preferences is −0.137 (2011), −0.147 (2015), and **+0.221 (2019)**. The sign reversal in 2019 is notable: S voters who wanted more pension spending also wanted more refugee spending in 2011 and 2015, but by 2019 the correlation had reversed — pension-generous S voters were now also refugee-restrictive. Among V voters, the correlation remains weak across all three waves (0.047, −0.086, 0.064). This spending-level finding reinforces the 2019 efterløn result: something distinctive happened among S voters' welfare-immigration attitudes in the 2019 election.
...
**Welfare chauvinism is a meaningful but minority segment.** Approximately 20–31% of voters of the six major parties hold welfare chauvinist attitudes depending on the wave, with a peak in 2019.

**S's dual strategy raised its welfare chauvinist vote share.** The share of welfare chauvinist S voters rose from 33% to 46% between 2015 and 2019, nearly matching DF's welfare chauvinist share. The pooled DiD confirms that S voters became relatively more immigration-restrictive compared to V voters in the post-2015 period (β=0.189, p=0.016), and this effect is S-specific.

**Ideological consistency, not welfare chauvinism, is the dominant attitude pattern.** The per-wave correlation between welfare generosity and immigration restrictiveness is consistently negative, indicating that left-on-both or right-on-both is more common than the cross-cutting welfare chauvinist combination.

**The 2019 evidence is the most compelling.** The efterløn item shows a sign reversal (β=0.084, p<0.001), and the spending battery correlation among S voters flips from −0.147 to +0.221. This convergence of evidence around the 2019 election — when S most explicitly ran on the dual strategy — suggests that welfare chauvinism's electoral salience is context-dependent and party-activated.

**Effects partially reversed by 2022.** The three-way interaction (welfare generosity × party × wave) is not significant at conventional levels, and the 2022 wave shows a return toward pre-2019 levels.
